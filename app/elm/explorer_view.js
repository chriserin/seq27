...
Elm.Explorer.make = function (_elm) {
   ...
   var indexOfArrangementNode = F2(function (flattenedArrangement,arrangementNode) {
      ...
      var _p0 = listTupleElement;
      if (_p0.ctor === "Just") {
            return $Maybe.Just($Basics.fst(_p0._0));
         } else {
            return $Maybe.Nothing;
         }
   });
   var Model = F3(function (a,b,c) {    return {sections: a,arrangement: b,cursorPosition: c};});
   var MusicalSection = F3(function (a,b,c) {    return {id: a,name: b,parts: c};});
   var Part = F2(function (a,b) {    return {id: a,name: b};});
   ...
   var flattenArrangement = function (arrangement) {
